...
<dependency>
  ...
  <artifactId>child-process-vertx-ext</artifactId>
...
----
dependencies {
  compile 'com.julienviet:child-process-vertx-ext:1.0.0-SNAPSHOT'
}
----

== Spawning child processes

You can spawn child processes with the `link:../../jsdoc/module-child-process-js_process-Process.html#spawn[Process.spawn]` method:

[source,js]
----
var Process = require("child-process-js/process");
...
`link:../../jsdoc/module-child-process-js_process-Process.html#env[Process.env]` gives you the current process environment key-value pairs
...
* `link:../../jsdoc/module-child-process-js_process-Process.html#stdin[stdin]`
* `link:../../jsdoc/module-child-process-js_process-Process.html#stdout[stdout]`
* `link:../../jsdoc/module-child-process-js_process-Process.html#stderr[stderr]`
...
Calling `link:../../jsdoc/module-child-process-js_process-Process.html#kill[kill]` kills the child process, on POSIX it sends the
`SIGTERM` signal.
...
Calling `link:../../jsdoc/module-child-process-js_process-Process.html#spawn[Process.spawn]` starts the process after the current event loop task

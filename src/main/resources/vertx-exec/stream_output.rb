...
# Generated from io.vertx.ext.childprocess.StreamOutput
module VertxExec
  class StreamOutput
    include ::Vertx::WriteStream
    # @private
    # @param j_del [::VertxExec::StreamOutput] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxExec::StreamOutput] the underlying java delegate
    def j_del
      @j_del
    end
